...
const getOwnProps = (obj: any): Array<string | symbol> => ([
    ...Object.getOwnPropertyNames(obj),
    ...(Object.getOwnPropertySymbols ? Object.getOwnPropertySymbols(obj) : [])
])

const propIt = (obj: any, method: string, ...args) => {
    /* eslint-disable-next-line */
    return getOwnProps(obj)[method](...args)
}
                    ...
                    if (isArray(object) === _isArray) {
                        if (!_isArray) {
                            ...
                            new Set([...getOwnProps(_object), ...getOwnProps(object)]).forEach(prop => {
                                const _entry = _object[prop]; const entry = object[prop]
